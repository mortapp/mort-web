  ...
  return (
    <>
      ...
      <div className="grid three" style={{ marginTop: 24 }}>
        <div className="card"><div className="card-icon-tile"><Icon name="🧭" size={18} /></div><h3>Built into the nav</h3><p>This feature is part of the MORT product surface and ready for database wiring.</p></div>
        <div className="card"><div className="card-icon-tile yellow"><Icon name="🛡️" size={18} /></div><h3>Safety gated</h3><p>Any teen-facing version should keep reporting, guardian controls, and moderation on.</p></div>
        <div className="card"><div className="card-icon-tile blue"><Icon name="🛠️" size={18} /></div><h3>Next backend step</h3><p>Add schema tables, RLS policies, and server actions for this module.</p></div>
      </div>
    </>
  )
}
